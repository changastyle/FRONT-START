...
else
{
      ...
      {
            // echo("COMPILARIA: index.php <br>");
            compilar("index" , $verbose);
      }
}
...
{
      // 1 - FUERZO QUE LA ENTRADA SEA .HTML: Y DENTRO DE LA CARPETA WIP/
      // echo("RUTA ENTRADA PARAM:" . $rutaEntradaParam ."<BR>");
      $rutaArchivoEntrada = "WIP/" . $rutaEntradaParam . ".html";
      ...
      foreach ((array) $archivoEntrada as $linea) 
      {
             ...
             if(str_contains($linea, "<include"))
            {
                  ...
                  if(str_starts_with($src, "../"))
                  {
                        ...
                        $src = "WIP/".substring_nico($src , $posSlash , strlen($src));
                        //echo ("---------<br>");
                  }
                  else
                  {
